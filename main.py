...
con = mysql.connector.connect(
    ...
    host="localhost", user="root", password="2239411", database="emp")

mycursor = con.cursor()

#mycursor.execute("CREATE TABLE Employee(id int PRIMARY KEY,name VARCHAR(50),post VARCHAR(50),salary FLOAT(50))")

#mycursor.execute("INSERT INTO Employee(id,name,post,salary) VALUES(%s,%s,%s,%s)",(1,"sumit","manager",70000))
